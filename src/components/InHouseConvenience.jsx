...
const conveniences = [
  ...
  {
    title: 'Inhouse Vegetable Vendor',
  ...
  return (
    <section className="section ihc" ref={rootRef}>
      <div className="container">
        <div className="ihc__head-box">
          <span className="ihc__eyebrow">In-House Convenience</span>
          <h2 className="ihc__title">Everyday Essentials, Right Downstairs</h2>
